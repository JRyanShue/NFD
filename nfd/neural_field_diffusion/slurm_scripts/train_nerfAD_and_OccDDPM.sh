...
CUDA_VISIBLE_DEVICES=1 python scripts/image_train.py --data_dir /viscam/projects/triplane-diffusion/data/occupancy_triplanes/triplanes --in_out_channels 96 --save_interval 500 $MODEL_FLAGS $TRAIN_FLAGS
